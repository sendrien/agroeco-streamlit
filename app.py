...
uploaded_file = st.sidebar.file_uploader(
    label="Téléverser le fichier Excel AGROECO", 
    type=["xlsx"],
    help="Sélectionnez votre fichier AGROECO 07072025.xlsx"
)
...
if uploaded_file is not None:
    ...
    @st.cache_data
    def load_data(io):
        df = pd.read_excel(io, sheet_name="Tous les résultats")
    ...
    st.warning("Veuillez téléverser le fichier Excel AGROECO (.xlsx) pour afficher le dashboard.")
